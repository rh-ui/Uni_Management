...
<head>
    ...
    <title>Boîte de récéption</title>
                                        ...
                                        <div class="row p-4 no-gutters align-items-center">
                                            <div class="col-sm-12 col-md-6">
                                                <h3 class="font-light mb-0">
                                                    <?php
                                                    $get_unread_msg = mysqli_query($connection, "SELECT COUNT(*) AS unread FROM `notification`,message WHERE notification.id_message = message.idMessage AND message.id_recepteur='$prof_id' AND status = 'unread';");
                                                    if ($get_unread_msg) {
