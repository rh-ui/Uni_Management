...
if (isset($_POST['stu-btn'])) {
    $_SESSION['id_module'] = $_POST['stu-btn'];
                ...
                if ($res) {
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="imgs\img_e2.jpg" class="card-img-top" alt="groupe image">
                            <div class="card-body center-flex">
                                <h5 class="card-title"></h5>
                                <p class="card-text"></p>
                                <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                                    <button type="submit" name='stu-btn' class="btn btn-light"
