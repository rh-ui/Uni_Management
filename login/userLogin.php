...
if (isset($_POST['apogee'])) {
    $Appogee = input_test(filter_var($_POST['apogee'],FILTER_VALIDATE_FLOAT));
    $get_student = mysqli_query($connection, "SELECT * FROM etudiant WHERE Apogee= $Appogee");
    if ($get_student) {
        $get_student = mysqli_fetch_assoc($get_student);
        ...
        $mail->Body = '<b>bonjour cher etudiant <br>voila votre nouveau mot de passe:<br></b>' . $new_password . '<b><br>sincere salutations</b>';
        $mail->send();
        if ($mail->send() == TRUE) {
        ...
        $set_new_psswd = mysqli_query($connection, "UPDATE etudiant SET password=$new_password where Apogee=$Appogee");
        if ($set_new_psswd) {
                                ...
                                <div class="modal-content">
                                    ...
                                    <Form method="POST" action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                        <div class="modal-body">
                                            <p class="py-2">
                                                entrez votre Apogee pour vous envoyer un vouveau mot de passe :
                                            </p>
                                            <div class="form-outline">
                                                <input id="typeEmail" class="form-control my-3" name="apogee"
                                                    placeholder="entrez votre Apogee" />
                                            </div>
                                        </div>
                        ...
                        <form method="POST" class="register-form" id="login-form" action="login.php">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="Apogee" id="your_name" placeholder="Votre Login"
